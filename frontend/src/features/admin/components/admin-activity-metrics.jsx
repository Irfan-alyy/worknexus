/**
 * Admin Activity Metrics Cards Component
 * Displays admin-specific metrics: employees, clients, projects, pending payroll
 */
...
function getMetricStyle(type) {
	const styles = {
		...
		clients: "border-teal-500/40 bg-teal-500/5 hover:bg-teal-500/10 cursor-pointer",
...
export function AdminActivityMetricsCards({ metrics, isLoading = false, onMetricClick }) {
	if (isLoading) {
		return (
